...
static const Key keys[] = {
  ...
  { MODKEY, XK_Print,                       spawn,                  SHCMD("flameshot screen -c")},
  ...
  { MODKEY|ControlMask,           XK_u,                       spawn,                  {.v = (const char*[]){"brave-browser","--app=https://uonetplus.vulcan.net.pl/warszawawola", NULL}}},
